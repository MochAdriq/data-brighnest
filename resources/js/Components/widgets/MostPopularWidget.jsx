            ...
            <div className="space-y-6">
                {articles.length > 0 ? (
                    articles.map((post, index) => (
                        <Link
                            key={post.id}
                            href={route("articles.show.public", post.slug)}
                        ...
                        >
                            ...
                            <div>
                                <h4 className="text-sm font-semibold text-slate-800 leading-snug group-hover:text-primary transition-colors mb-1 line-clamp-2">
                                    {post.title}
                                </h4>
