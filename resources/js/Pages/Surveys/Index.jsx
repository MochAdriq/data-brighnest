...
export default function SurveyIndex({ auth }) {
    const { flash } = usePage().props;

    // Setup Form dengan Field Baru
    const { data, setData, post, processing, errors, reset } = useForm({
        title: "", // Judul Data
        category: "", // Salah satu dari 7 Kategori
        subcategory: "", // <--- TAMBAHAN BARU
        period: "", // Periode (Bulan/Tahun)
        pic: "", // Penanggung Jawab (Manual)
        description: "", // Catatan
        file: null, // File Excel
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        // Nanti route ini akan kita update Controller-nya
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                                        {CATEGORIES.map((cat) => (
                                            <div
                                                key={cat.id}
                                                // UBAH DISINI: Pakai handleCategoryChange
                                                onClick={() =>
                                ...
                                {data.category && (
                                    <div className="animate-fade-in-down bg-gray-50 p-4 rounded-lg border border-gray-200">
                                        ...
                                        >
                                            ...
                                            {/* Ambil list sub kategori berdasarkan kategori yg dipilih */}
